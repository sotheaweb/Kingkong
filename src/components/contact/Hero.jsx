...
const Hero = () => {
  return (
    ...
    >
        <h1 
         className='md:w-[30%] text-3xl text-start md:text-4xl font-bold text-gray-800 mb-4 mx-5 lg:mx-1'
        ...
        <p 
         className='md:w-[30%] text-gray-800 text-start text-sm lg:text-md mt-10 md:mt-20'
         data-aos="fade-up" data-aos-delay="150"
        > 
